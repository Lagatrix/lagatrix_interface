<template>
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="0 0 388.2 150.6"
    style="enable-background: new 0 0 388.2 150.6"
    xml:space="preserve"
  >
    <rect y="2.1" class="st0" width="28.1" height="28.1" />
    <path
      class="st1"
      d="M27.4,148.5V47.3H0.8v101.2H27.4z M204.2,149.5v-24.8c-3.9,0-7.2-0.2-9.6-0.6c-2.8-0.4-4.9-1.4-6.3-2.8
    ...
    <path
      class="st1"
      d="M387.4,135.3c-0.5-1.2-1.2-2.2-2.1-3.1c-0.9-0.9-1.9-1.6-3.1-2.1s-2.5-0.8-3.8-0.8c-1.4,0-2.6,0.3-3.8,0.8
